...
function installStub(result: Awaited<ReturnType<OverlookApi['appLock']['unlock']>>): void {
  (globalThis as { overlook?: Partial<OverlookApi> }).overlook = {
    appLock: {
      ...
      setAnchorPolicy: () => Promise.resolve({ changed: false, reason: null, retryAfterMs: 0, attemptsRemaining: 3 }),
      ...
      touchIdEnable: () => Promise.resolve({ enabled: true, reason: null, retryAfterMs: 0, attemptsRemaining: 3 }),
