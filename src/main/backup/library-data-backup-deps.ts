 ...
 * organizational tags (schema 9, #505). One place so `main/index.ts` stays a
 * wiring file. */
export function libraryDataBackupDeps(
  ...
  BackupEngineDeps,
  'activitySnapshot' | 'boardsSnapshot' | 'galleryPolicySnapshot' | 'hiddenAlbumIdsSnapshot' | 'albumTreeSnapshot'
> {
  return {
