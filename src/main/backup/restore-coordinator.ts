      ...
      for (const source of sources) {
        try {
          ...
          libraries.push({
            ...
            excludedCount: 'coverage' in candidate.manifest ? candidate.manifest.coverage.excludedCount : 0,
            excludedBytes: 'coverage' in candidate.manifest ? candidate.manifest.coverage.excludedBytes : 0,
