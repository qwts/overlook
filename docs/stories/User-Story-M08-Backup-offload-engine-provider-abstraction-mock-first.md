...
| [#277](https://github.com/qwts/photos/issues/277) | Google Drive provider: desktop OAuth, resumable object custody, restore   | #280, #287          |

## Acceptance coverage

| Flow                                                                                                                                                                                                                           | Status                               | Coverage                                                                                                                                                                                                                                                                                     |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ADR-0007 accepted: remote layout `/Overlook/<library-id>/{manifest,blobs/<h2>/<hash>}`, encrypt-once envelopes, generation-numbered encrypted manifest (N=2), verify-gates-offload, mock-first provider                        | ✅ #102 (ADR-0007)                   | ADR page + epic decisions                                                                                                                                                                                                                                                                    |
...
| Custody-safe disconnect: exact provider/account risk counts, restore-first and emergency paths, provider-required persistence, and distinct failure truth in Settings, Inspector, Lightbox, and Export                         | ✅ #734                              | [Custody truth acceptance](../acceptance/Acceptance-Test-Custody-Truth.md), `tests/e2e/offload-ui.spec.ts`, custody routing/presentation tests, and Settings/Inspector/Lightbox/Export Storybook interactions — ledger id `m19-ephemeral-cloud-original-custody`                             |
| Google Drive: installed-app PKCE/loopback OAuth, sealed refresh-token custody, app-owned Drive tree, resumable uploads, stale-ID repair, checksum fallback, provider-neutral UI/restore, and shared disaster-recovery contract | 🟡 #277 (PR #344; live gate pending) | `tests/backup/google-drive-*.test.ts`, `tests/backup/provider-runtime.test.ts`, `tests/e2e/settings.spec.ts`, and `src/renderer/src/settings/SettingsDialog.stories.tsx` — ledger id `m20-google-drive-provider`                                                                             |
