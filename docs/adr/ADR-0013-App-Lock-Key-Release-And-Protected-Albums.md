...
Malformed or unauthenticated records require recovery in both modes. Editing the policy breaks slot authentication. Only usability may establish a fresh-machine anchor from intact credentials; hardened uses the recovery file.
